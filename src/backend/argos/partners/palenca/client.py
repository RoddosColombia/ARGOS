"""PalencaClient · Phase 2 stub · integración real llega en Phase 3.

Sin PALENCA_API_KEY → mock con ingreso_mensual=2500000 (~ mototaxista típico Bogotá)
y estabilidad_meses=8.
"""
