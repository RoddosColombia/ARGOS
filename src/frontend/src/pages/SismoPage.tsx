...
import type { InventoryResponse, InventoryType } from "@/types/sismo";
...
export function SismoPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      <header>
        <h1 className="text-2xl font-semibold text-ink-900">Inventario SISMO</h1>
        <p className="mt-1 text-sm text-ink-500">
          Snapshot read-only del último sync · {query.data?.fecha_sync_date ?? "sin datos"}
        </p>
      </header>
